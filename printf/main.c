...
int	main(void)
{
	...
	z = 40;
	ft_printf("Eu sou o %s, tenho %d anos e %i meses. 12 em x e' %x e em X e'
		%X. o caracter %c e' C e o ponteiro tem address %p", "Artur", 23, 9, 12,
		12, 'C', &z);
	printf("Eu sou o %s, tenho %d anos e %i meses. 12 em x e' %x e em X e'
		%X. o caracter %c e' C e o ponteiro tem address %p", "Artur", 23, 9, 12,
		12, 'C', &z);
	...
	ft_printf("%u\n", 4294967295);
		// Saída esperada: Valor máximo de um inteiro sem sinal
	...
	x = 42;
	ft_printf("meu -----%p\n", (void *)&x);
		// Saída esperada: Endereço de memória de x
	printf("original -----%p\n", (void *)&x);
